...
export async function createToken(username: string, role: UserRole): Promise<string> {
...
export async function getServerSession(): Promise<{ username: string; role: UserRole } | null> {
